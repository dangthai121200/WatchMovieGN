...
public class ConstantDatabase {
    ...
    public static final String COLUMN_REQUEST_HISTORY_ID = "PK_ID_REQUEST_HISTORY";
    public static final String COLUMN_CLASS_REQUEST_HISTORY_BODY = "CLASS";
    public static final String COLUMN_REQUEST_HISTORY_BODY = "BODY";
    public static final String COLUMN_REQUEST_HISTORY_STATUS = "STATUS";
    public static final String COLUMN_REQUEST_HISTORY_START = "START";
    public static final String COLUMN_REQUEST_HISTORY_CALL_TO = "CALL_TO";
    public static final String COLUMN_REQUEST_REASON_ERROR = "REASON_ERROR";
